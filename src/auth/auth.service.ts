      ...
      if(firstUser.password == password) {
        const userData = {
          ...
          coinDict: {
            ...
            twograde: firstUser.twogradecoin,
            threegrade: firstUser.threegradecoin,
  ...
  async usersave(userData: any) {
    ...
    let coindata2 = await this.userRepository
      ...
      .set({
        ...
        twograde: UserJsonData.coinDict.twogradecoin,
        threegrade: UserJsonData.coinDict.threegradecoin,
