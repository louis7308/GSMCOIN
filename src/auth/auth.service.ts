      ...
      if(firstUser.password == password) {
        const userData = {
          ...
          coinDict: {
            ...
            twogradecoin: firstUser.twogradecoin,
            threegradecoin: firstUser.threegradecoin,
  ...
  async usersave(userData: any) {
    ...
    let coindata2 = await this.userRepository
      ...
      .set({
        ...
        twogradecoin: UserJsonData.coinDict.twogradecoin,
        threegradecoin: UserJsonData.coinDict.threegradecoin,
